...
💻 I build simple, useful, and creative software.  
🌱 Always exploring new ideas in code, design, and open-source.

---

### 🚀 About Me
- 🧠 Passionate about tech and coding  
- 🔧 Currently working on: personal tools
- 🌍 Based on the idea that great design = simple + smart
- 🎯 Goal: make things that people actually *enjoy* using  
